...
heroText: Qwang's blog
tagline: Web前端技术博客，积跬步以至千里，记录每一个学习瞬间。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 前端文章
    details: html(5)/css(3)、JavaScript、ES6、Vue框架等前端技术笔记文档
    link: /web/ # 可选
    imgUrl: /img/web.png # 可选

  - title: 学习总结
    details: 学习计划，工作学习总结，遇到问题整理
    link: /learn/
    imgUrl: /img/ui.png

  - title: 生活随笔
    details: 记录生活，读书笔记，观影笔记，吐槽笔记
    link: /life/
